...
if __name__ == '__main__':
    ...
    ## Required parameters
    parser.add_argument("--predict_file_path", default='../PromptCS/models/polycoder4b/saved_models_wt4_200/checkpoint-best-bleufine/test_0.output', type=str)
    parser.add_argument("--ground_truth_file_path", default='../PromptCS/models/polycoder4b/saved_models_wt4_200/checkpoint-best-bleufine/test_0.gold', type=str)
