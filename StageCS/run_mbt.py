...
def main():
    ...
    parser.add_argument("--model_name_or_path", default='./LLMs/PolyCoder-160M', type=str,
                        help="Path to pre-trained model")
    parser.add_argument("--output_dir", default='models/saved_models_poly_multi1', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--load_model_path",
                        default='./models/saved_models_poly_multi1/checkpoint-best-bleu/pytorch_model.bin', type=str,
