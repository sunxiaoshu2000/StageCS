...
def main():
    ...
    parser.add_argument("--output_dir", default='models/codegenmodels/saved_models_wtt', type=str,
                        help="The output directory where the model predictions and checkpoints will be written.")
    parser.add_argument("--load_model_path", default='./models/codegenmodels/saved_models_wtt/checkpoint-best-bleu/pytorch_model.bin', type=str,
